  ...
  return (
    <section id="start" className="scroll-mt-16 bg-dark">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:py-20 md:py-28">
        ...
        <h1 className="font-brand text-3xl font-semibold leading-[1.12] tracking-tight text-on-dark sm:text-4xl md:text-5xl">
          {content.title}
        </h1>
        <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-on-dark/85 md:text-lg">
          {content.subtitle}
        </p>
